...
const ProjectPage = props => {
	const project = projectsFile.projects.filter(project => project.name === props.match.params.projectName)[0];

	return (
		<Grid container spacing={32}>
			<Grid item xs={12}>
				<Paper className={props.classes.paper}>
					<img src={require('../assets/' + project.logo)} alt="Logo du projet" className={props.classes.picture} />
					<div>
